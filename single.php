      ...
      itemtype="http://schema.org/ListItem"><a href="<?php echo get_category_link( $catid ); ?>" itemprop="item">
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class('st-post'); ?>>
				...
				<div class="st-aside">
					...
					<!--ページナビ-->
					<div class="p-navicontainer clearfix">
						<dl class="p-navibox">
							<div class="p-navi-prev">
								<?php
								...
								if ( ! empty( $prev_post ) ) :
									...
									<dd>
										<a href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>">
											<?php echo esc_html( get_the_time( 'Y-m-d', $prev_post->ID ) ); ?> <?php echo esc_html( $prev_post->post_title ); ?>
										</a>
									</dd>
								<?php endif; ?>
							</div>
							<div class="p-navi-next">
								<?php
								$next_post = get_next_post();
								if ( ! empty( $next_post ) ) :
									?>
									<dt><i class="fas fa-chevron-right"></i></dt>
									<dd>
									<a href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>">
										<?php echo esc_html( get_the_time( 'Y-m-d', $next_post->ID ) ); ?> <?php echo esc_html( $next_post->post_title ); ?>
									</a>
									</dd>
								<?php endif; ?>
							</div>
